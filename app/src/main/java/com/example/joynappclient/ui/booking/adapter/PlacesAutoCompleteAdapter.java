...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<PlacesAutoCompleteAdapter.PredictionHolder> implements Filterable {
    ...
    public PlacesAutoCompleteAdapter(Context context, PlacesClient placesClient, LatLngBounds lngBounds) {
        mContext = context;
        STYLE_BOLD = new StyleSpan(Typeface.BOLD);
        STYLE_NORMAL = new StyleSpan(Typeface.NORMAL);
        this.placesClient = placesClient;
        this.lngBounds = lngBounds;
    }
        ...
        return new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                if (results != null && results.count > 0) {
                    // The API returned at least one result, updateUserLogin the data.
    ...
    private ArrayList<PlaceAutocomplete> getPredictions(CharSequence constraint) {
        ...
        RectangularBounds bounds = RectangularBounds.newInstance(lngBounds);

        Log.d(TAG, "getPredictions: " + lngBounds.northeast + " , " + lngBounds.southwest);
    ...
    public PredictionHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View convertView = layoutInflater.inflate(R.layout.list_item_place_map_autocomplete, viewGroup, false);
