package com.example.joynappclient.data.gmap;
...
public class GMapDirection {
    ...
    public final static String API_KEY = "AIzaSyDYEDr9rDN5OaB0resyYN47rL1vZpXk8mw"; //please enter API KEY Google Maps
