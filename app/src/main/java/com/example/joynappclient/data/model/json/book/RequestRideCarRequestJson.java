package com.example.joynappclient.data.model.json.book;
...
public class RequestRideCarRequestJson implements Serializable {
    ...
    private String waktuPerjalanan;
    ...
    public String getWaktuPerjalanan() {
        return waktuPerjalanan;
    }

    public void setWaktuPerjalanan(String waktuPerjalanan) {
        this.waktuPerjalanan = waktuPerjalanan;
    }
